<%@ Page Title="KeywordEdit" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Edit.aspx.cs" Inherits="Nokkelord.Keywords.Edit" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <asp:FormView runat="server"
            ItemType="Nokkelord.Models.Keyword" DefaultMode="Edit" DataKeyNames="KeywordID"
