<%@ Page Title="ItemKeywordList" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Default.aspx.cs" Inherits="Nokkelord.ItemKeywords.Default" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div>
        <asp:ListView id="ListView1" runat="server"
			...
			ItemType="Nokkelord.Models.ItemKeyword"
            ...
            <LayoutTemplate>
                <table class="table">
                    <thead>
                        <tr>
                            <th>
								<asp:LinkButton Text="Varenøkkelordnavn" CommandName="Sort" CommandArgument="ItemKeywordName" runat="Server" />
							</th>
                            <th>
								<asp:LinkButton Text="ItemNo" CommandName="Sort" CommandArgument="ItemNo" runat="Server" />
							</th>
                            <th>
								<asp:LinkButton Text="Beskrivelse " CommandName="Sort" CommandArgument="Description" runat="Server" />
							</th>
                            <th>
